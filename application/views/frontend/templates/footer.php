...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						...
						<div class="logos ml-sm-auto">
							<ul class="logos_list">
								<li><a href="#"><img src="<?= base_url('assets/frontend/'); ?>images/logos_1.png" alt=""></a></li>
								<li><a href="#"><img src="<?= base_url('assets/frontend/'); ?>images/logos_2.png" alt=""></a></li>
								<li><a href="#"><img src="<?= base_url('assets/frontend/'); ?>images/logos_3.png" alt=""></a></li>
								<li><a href="#"><img src="<?= base_url('assets/frontend/'); ?>images/logos_4.png" alt=""></a></li>
							</ul>
						</div>
					</div>
				</div>
